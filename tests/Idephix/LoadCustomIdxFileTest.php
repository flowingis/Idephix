...
class LoadCustomIdxFileTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $output = shell_exec("php " . __DIR__ . "/../../bin/do.php -f " .__DIR__ . "/../Test/idxfile_custom.php hello");
    ...
    {
        $output = shell_exec("php " . __DIR__ . "/../../bin/do.php --file " .__DIR__ . "/../Test/idxfile_custom.php hello");
    ...
    {
        $output = shell_exec("php " . __DIR__ . "/../../bin/do.php -f " .__DIR__ . "/../Test/idxfile_custom.php idephix:test-params non per me");
    ...
    {
        $output = shell_exec("php " . __DIR__ . "/../../bin/do.php");
    ...
    {
        $output = shell_exec("php " . __DIR__ . "/../../bin/do.php -f not_existent.php hello");
